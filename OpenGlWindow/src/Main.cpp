...
void processInput(GLFWwindow* window, Camera& cameras);
void addTexture(const std::string& imgSrc, unsigned int& texture);
void mouse_callback(Camera& camera, GLFWwindow* window, double xpos, double ypos);
void scroll_callback(Camera& camera, GLFWwindow* window, double xoffset, double yoffset);
...
int main()
{
    ...
    addTexture("assets/img/container2.jpg", diffuseMap);
    addTexture("assets/img/container2_specular.jpg", specularMap);
    addTexture("assets/img/matrix.jpg", emissionMap);
    ...
    glfwSetCursorPosCallback(window, [](GLFWwindow* window, double x, double y)
    {
        ...
        mouse_callback(*camera, window, x, y);
    });

    glfwSetScrollCallback(window, [](GLFWwindow* window, double x, double y)
    {
        Camera* camera = static_cast<Camera*>(glfwGetWindowUserPointer(window));
        scroll_callback(*camera, window, x, y);
    });
